...
The first argument for the Blockbuster function is a data.frame containing the data for the elements that you wish to simulate.  This data.frame must contain the following columns:

| Column | Description |
|:---|:---|
| buildingid | A number that uniquely identifies the building a component is part of |
