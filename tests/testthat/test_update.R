...
test_that("Updated figures are correct", {
  ...
  element <- data.frame(A, B, C, D, E, ab = 0.8, bc = 0.7, cd = 0.6, de = 0.5,
                        ...
                        B.repair.total = 9, C.repair.total = 3,
                        D.repair.total = 1, E.repair.total = 7, # note the incorrect values
                        gifa = 1, unit_area = 1)
  correct <- data.frame(A, B, C, D, E, ab = 0.8, bc = 0.7, cd = 0.6, de = 0.5,
                        elementid = 1:6, buildingid = 1, B.repair.cost = 1,
                        C.repair.cost = 2, D.repair.cost = 3, E.repair.cost = 4,
                        B.repair.total = B, C.repair.total = C * 2,
                        D.repair.total = D * 3, E.repair.total = E * 4, # correct figures
                        gifa = 1, unit_area = 1)
  correct10 <- data.frame(A, B, C, D, E, ab = 0.8, bc = 0.7, cd = 0.6, de = 0.5,
                          elementid = 1:6, buildingid = 1, B.repair.cost = 1,
                          C.repair.cost = 2, D.repair.cost = 3, E.repair.cost = 4,
                          B.repair.total = B * 10, C.repair.total = C * 20,
                          D.repair.total = D * 30, E.repair.total = E * 40, # correct figures
                          gifa = 1, unit_area = 10)
  element10 <- data.frame(A, B, C, D, E, ab = 0.8, bc = 0.7, cd = 0.6, de = 0.5,
                          elementid = 1:6, buildingid = 1, B.repair.cost = 1,
                          C.repair.cost = 2, D.repair.cost = 3, E.repair.cost = 4,
                          B.repair.total = 9, C.repair.total = 3,
                          D.repair.total = 1, E.repair.total = 7, # note the incorrect values
